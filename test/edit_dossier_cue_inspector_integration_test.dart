      ...
      home: Scaffold(
        body: SizedBox(
          ...
          child: EditSurface(
            ...
            onSeek: (_) {},
            // Keep folder/image discovery deterministic and filesystem-free.
...
void main() {
  testWidgets('EDIT inspector authors DOSSIER at playhead and undo restores source',
    ...
    await tester.pumpAndSettle();
    expect(find.textContaining('source F90'), findsWidgets);

    await tester.tap(add);
    await tester.pumpAndSettle();

    await tester.enterText(
      find.byKey(const ValueKey<String>('edit-dossier-cue-folder-field')),
      'evidence',
    );
    await tester.enterText(
      find.byKey(const ValueKey<String>('edit-dossier-cue-image-field')),
      'person.png',
    );
    await tester.enterText(
