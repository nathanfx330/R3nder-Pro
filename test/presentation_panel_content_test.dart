...
[/PANEL]''';
  ...
  test('authored reference sizes and image percentage round trip', () {
    const String source = '''[PANEL]
PRESET: EDITORIAL
HEADING_SIZE: 32
BODY_SIZE: 17
...
Biography.''';
    ...
    expect(parsed.imageFraction, closeTo(0.38, 0.000001));
  ...
  test('invalid image percentage is preserved and reported', () {
    const String source = '''[PANEL]
PRESET: EDITORIAL
IMAGE: enormous
[/PANEL]''';
    ...
    expect(parsed.hasErrors, isTrue);
    expect(parsed.preservedDirectives, contains('IMAGE: enormous'));
    expect(
      parsed.issues.single.code,
      PresentationPanelIssueCode.malformedDirective,
    );
  });
