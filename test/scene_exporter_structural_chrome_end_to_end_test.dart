...
void main() {
  testWidgets(
      'SceneExporter preserves FULL CUSTOM STRUCT chrome in encoded H264',
...
''';
    ...
    expect(
      bestHeader,
      greaterThan(20),
      reason: 'Encoded MP4 must retain STRUCT title/top chrome pixels.',
    );
    expect(
      bestBottom,
      greaterThan(5),
      reason: 'Encoded MP4 must retain STRUCT bottom chrome pixels.',
    );
  });
}
