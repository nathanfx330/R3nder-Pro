...
int main(int argc, char** argv) {
  ...
  // Prove the new live path independently. It must return pending rather than
  // block while the worker catches up, then eventually produce the exact frame.
  // The sequence covers a jump, a sequential request, and a backward jump.
  if (ok) {
